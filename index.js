...
mongoose.connect("mongodb+srv://ndz123:8RzrIxZfG5bIjkwA@cluster0.miyegtt.mongodb.net/?retryWrites=true&w=majority");
...
app.post('/api/users', async function (req, res) {
  ...
  try {
    const user = await retryOnTimeout(() => newUser.save());
...
async function retryOnTimeout(fn, retries = 3) {
  ...
  throw new Error('Operation timed out after multiple retries.');
}
